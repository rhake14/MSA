...
The MSAT is an non-adaptive instrument to test musical scene analysis abilities among very diverse populations.
...
The MSAT currently supports English (en), German (de),
You can select one of these languages by passing a language code as 
an argument to `MSAT_standalone()`, e.g. `MSAT_standalone(languages = "en")`,
