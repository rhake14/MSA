...
- An offline alternative would be to download the entire repository 
  and stimuli set (folder: MSA - all in one) to your local computer
  ...
  (using “location_stim” within the function "MSA_standalone()" /
  "MSA()"; see also "?MSA" and location_stim for more information).
